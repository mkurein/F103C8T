...
3. FreeRTOS heap  
   ...
   В вашем проекте: `10 KB` (`Core/Inc/FreeRTOSConfig.h`; раньше было 14 KB, см. таблицу версий ниже).
...
- при этом есть FreeRTOS heap (тогда 14 KB, сейчас 10 KB) + стеки задач.
